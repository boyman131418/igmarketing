    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      ...
      <div className="max-w-2xl w-full relative z-10">
        <div className="text-center mb-12 animate-fade-up">
          <h1 className="text-4xl font-display font-bold mb-4">{t('chooseYourRoleTitle')}</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <h2 className="text-2xl font-display font-bold mb-3">{t('imABuyer')}</h2>
            <p className="text-muted-foreground mb-6">
              {t('buyerRoleDesc')}
            </p>
            <div className="flex items-center text-primary font-semibold">
              <span>{t('startBuying')}</span>
          ...
          >
            ...
            <h2 className="text-2xl font-display font-bold mb-3">{t('imASeller')}</h2>
            <p className="text-muted-foreground mb-6">
              {t('sellerRoleDesc')}
            </p>
            <div className="flex items-center text-primary font-semibold">
