    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      ...
      <div className="glass-card rounded-3xl p-10 max-w-md w-full relative z-10 animate-scale-in">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-display font-bold mb-3">Welcome to IG Market</h1>
          <p className="text-muted-foreground">
            Sign in to start buying or selling Instagram accounts
          </p>
        </div>

        <Button
          onClick={signInWithGoogle}
          className="w-full h-14 bg-foreground text-background hover:bg-foreground/90 font-semibold text-lg rounded-xl transition-all duration-300"
        >
